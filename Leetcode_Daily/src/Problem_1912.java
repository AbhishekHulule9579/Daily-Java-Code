...
public class Problem_1912 {
    public static void main(String[] args) {
        ...
        System.out.println("Search movie 1: " + system.search(1));
        // Should show shops with movie 1 sorted by price -> [1, 0, 2]

        system.rent(1, 1);   // Shop 1 rents movie 1
        system.rent(0, 2);   // Shop 0 rents movie 2

        System.out.println("Report rented movies: " + system.report());
        // Should list rented movies sorted by price/shop/movie

        system.drop(1, 1);   // Return movie 1 to shop 1

        System.out.println("Search movie 1 after drop: " + system.search(1));
        // Movie 1 is available again at shop 1
    }
}
